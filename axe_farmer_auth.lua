...
function decrypt_key(p2)
	...
	local v8, v9, v10 = string.gmatch('XOPELCOGMQO', '%u')
	local v11 = {}
	while true do
		v10 = v8(v9, v10)
		if v10 == nil then
		...
		table.insert(v11, tonumber(v6[v10]))
	end
	local v12, v13, v14 = ipairs({ string.byte(p2, 1, -1) })
	local v15 = ''
	while true do
		local v16
		v14, v16 = v12(v13, v14)
		...
		local v17 = v11[(v14 - 1) % #v11 + 1]
		local v18 = (v16 - string.byte('A') + 1 - v17 - 1) % 26 + 1
		v15 = v15 .. string.char(v18 + string.byte('A') - 1)
	end
	return v15
end
local v19 = game.HttpService:JSONDecode(game:HttpGet('https://server.linest.repl.co/check?key=' .. auth_key))
if string.upper(auth_key) ~= decrypt_key(v19) then
